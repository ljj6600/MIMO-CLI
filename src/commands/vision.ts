...
export default defineCommand({
  ...
  options: [
    { flag: '--image <path|url>', description: 'Image file path or URL' },
    { flag: '--audio <path|url>', description: 'Audio file path or URL' },
    { flag: '--video <path|url>', description: 'Video file path or URL' },
    { flag: '-p, --prompt <text>', description: 'Question about the content', required: true },
    { flag: '--model <model>', description: 'Model name (default: mimo-v2.5)' },
    { flag: '--stream', description: 'Streaming output (default: on, use --no-stream to disable)', default: true },
    { flag: '--no-stream', description: 'Disable streaming output' },
    { flag: '--fps <n>', description: 'Video frame rate (default: 2)', type: 'number' },
    { flag: '--media-resolution <value>', description: 'Video resolution: default | max' },
  ],
  examples: [
