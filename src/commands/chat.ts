...
export default defineCommand({
  ...
  options: [
    { flag: '-m, --message <text>', description: 'Message text', required: true },
    ...
    { flag: '--force-search', description: 'Force web search' },
    { flag: '--max-keyword <n>', description: '一轮搜索最大关键词数量', type: 'number' },
    { flag: '--search-limit <n>', description: '搜索结果数量限制', type: 'number' },
    { flag: '--user-country <country>', description: '用户位置：国家' },
    { flag: '--user-region <region>', description: '用户位置：地区' },
    { flag: '--user-city <city>', description: '用户位置：城市' },
    ...
    { flag: '--max-tokens <n>', description: 'Max completion tokens', type: 'number' },
